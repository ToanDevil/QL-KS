...
public class LichDatPhongController {
	...
	public String dslichdatphong(ModelMap model, @RequestParam("maPhong") Integer maPhong,
	...
	@GetMapping("themlich")
	public String themlich(ModelMap model, HttpServletRequest httpServletRequest,
			@RequestParam("maPhong") Integer maPhong, @RequestParam("soPhong") Integer soPhong) {
	...
	public String actionthemlich(ModelMap model, @ModelAttribute("lichDatPhong") LichDatPhong lichDatPhong,
			@RequestParam("maPhong") Integer maPhong, @RequestParam("soPhong") Integer soPhong) {
	...
	public String actionthemlich(ModelMap model, @RequestParam("maPhong") Integer maPhong,
			@RequestParam("soPhong") Integer soPhong, @RequestParam("maLich") Integer maLich) {
	...
	public String actionxoalichds(ModelMap model, @RequestParam("maPhong") Integer maPhong,
			@RequestParam("maLich") Integer maLich) {
		lichDatPhongService.deleteById(maLich);
		updateCountDatLich(maPhong);
