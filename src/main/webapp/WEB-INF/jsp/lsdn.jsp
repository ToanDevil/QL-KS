...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
           ...
           <div class="input-group">
            <input class="form-control" type="text" name="data" placeholder="Nhập tài khoản cần tìm" maxlength="50" value="${data }" required/>
           ...
           <th>Tài khoản</th><th>Ngày đăng nhập</th><th>Giờ đăng nhập</th>
           </tr>
           </thead>
...
<ul class="pagination" id="pagination" style="float: right;box-shadow: 1px 1px 5px #888888;">
	<li class="page-item first"><a href="lsdnpage?data=${data }&page=${trangdau }" class="page-link">Trang đầu</a></li>
	...
	<li class="page-item last"><a href="lsdnpage?data=${data }&page=${trangcuoi }" class="page-link">Trang cuối</a></li>
</ul>
<br><br>
</c:if>
 ...
 <br>
<ul class="pagination" id="pagination" style="float: right;box-shadow: 1px 1px 5px #888888;">
	<li class="page-item first"><a href="lsdnpagetim?data=${data }&page=${trangdau }" class="page-link">Trang đầu</a></li>
	...
	<li class="page-item last"><a href="lsdnpagetim?data=${data }&page=${trangcuoi }" class="page-link">Trang cuối</a></li>
</ul>
<br><br>
</c:if>
            </div>
