				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<frm:input id="tendv" class="form-control" path="tenDichVu"
							placeholder="Nhập tên dịch vụ" maxlength="50"/>
					</div>
				</div>

				<div class="form-group">
					<label style="font-weight: bold;" for="loaidv">Loại dịch
						vụ:</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<frm:input type="number" id="giadv" class="form-control"
							path="giaDichVu" placeholder="Nhập giá dịch vụ" oninput="checkMaxLenghtNumber(this,12)"/>
					</div>
				</div>
