...
<div>
	   ...
	   <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="password" name="matkhaucu" id="matkhaucu" class="form-control" placeholder="Nhập mật khẩu cũ" maxlength="100" required="required">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="password" name="matkhaumoi" id="matkhaumoi" class="form-control" placeholder="Nhập mật khẩu mới" maxlength="100" required="required" >
		</div>
	</div>
		...
		<div class="col-sm-10">
			<frm:input path="matKhau" type="password"  class="form-control" placeholder="Xác nhận mật khẩu mới" maxlength="100" required="required" ></frm:input>
		</div>
	</div>
