...
<div id="getFullSize" style="height: 100%;width: 100%;position: fixed;top: 0; left: 0;pointer-events: none;"></div>
...
<body id="page-top" style="font-family: Arial">
	...
	<div class="check-device"
		...
		<p class="csstextcanhbao">Vui lòng xoay ngang thiết bị.</p>
	...
	<nav id="mainNav"
		...
		<a
			class="navbar-brand csstexttochuc" href="#"><span
		...
		<div class="collapse navbar-collapse" id="navbarExample">
			<ul id="menuUl" class="sidebar-nav navbar-nav">
				...
				<li class="nav-item ${activethuchi }"><a class="nav-link"
					href="thuchi" style="text-shadow: 0px 0px 1px #888888;"><i
						class="fa fa-money"></i> Thu chi</a></li>
				<li class="nav-item"><a
					...
					style="text-shadow: 0px 0px 1px #888888;"><i
						class="fa fa-search"></i> Tìm kiếm thông tin</a>
					<ul class="sidebar-second-level collapse${chamshowtktt }"
						id="collapseComponents">
						<li class="nav-item ${activettkh }"><a href="ttkh">Thông
								tin khách hàng</a></li>
						<li class="nav-item ${activettp }"><a href="ttp">Thông
								tin phòng</a></li>
				...
				<li class="nav-item"><a
					...
					style="text-shadow: 0px 0px 1px #888888;"><i
						class="fa fa-calendar-check-o"></i> Thống kê và báo cáo</a>
					<ul class="sidebar-second-level collapse${chamshowtkvbc }"
						id="collapseMulti1">
						<li class="nav-item ${activelsdtp }"><a href="lsdtp">Lịch
								sử đặt / trả phòng</a></li>
						<li class="nav-item ${activelsdv }"><a href="lsdv">Lịch
								sử dịch vụ</a></li>
						<li class="nav-item ${activettdt }"><a href="tkdt">Thống
								kê doanh thu</a></li>
						<c:if test="${not empty ancaidai }">
							<li class="nav-item ${activelsdn }"><a href="lsdn">Lịch
									sử đăng nhập</a></li>
						</c:if>
					</ul></li>
				...
				<c:if test="${not empty ancaidai }">
					<li class="nav-item"><a
						...
						style="text-shadow: 0px 0px 1px #888888;"><i
							class="fa fa-fw fa-wrench"></i> Cài đặt</a>
						<ul class="sidebar-second-level collapse${chamshowcd }"
							...
							<li class="nav-item"><a
								...
								data-toggle="collapse" href="#collapseMulti10"><i
									class="fa fa-fw fa-sitemap"></i> Quản lý tài khoản</a>
								<ul class="sidebar-second-level collapse${chamshowqltk }"
									id="collapseMulti10">
									<li class="nav-item ${activedstk }"><a href="qltk">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Danh
											sách tài khoản</a></li>
									<li class="nav-item ${activettk }"><a href="addtk">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Thêm
											tài khoản</a></li>
								</ul></li>
							...
							<li class="nav-item"><a
								...
								data-toggle="collapse" href="#collapseMulti11"><i
									class="fa fa-fw fa-sitemap"></i> Quản lý loại phòng</a>
								<ul class="sidebar-second-level collapse${chamshowqllp }"
									id="collapseMulti11">
									<li class="nav-item ${activedslp }"><a href="qllp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Danh
											sách loại phòng</a></li>
									<li class="nav-item ${activetlp }"><a href="addlp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Thêm
											loại phòng</a></li>
								</ul></li>
							...
							<li class="nav-item"><a
								...
								data-toggle="collapse" href="#collapseMulti12"><i
									class="fa fa-fw fa-sitemap"></i> Quản lý phòng</a>
								<ul class="sidebar-second-level collapse${chamshowqlp }"
									id="collapseMulti12">
									<li class="nav-item ${activedsp }"><a href="quanlyphong">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Danh
											sách phòng</a></li>
									<li class="nav-item ${activetp }"><a href="addqlp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Thêm
											phòng</a></li>
								</ul></li>
							...
							<li class="nav-item"><a
								...
								data-toggle="collapse" href="#collapseMulti13"><i
									class="fa fa-fw fa-sitemap"></i> Quản lý dịch vụ</a>
								<ul class="sidebar-second-level collapse${chamshowdv }"
									id="collapseMulti13">
									<li class="nav-item ${activedsdv }"><a href="dsqldv">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Danh
											sách dịch vụ</a></li>
									<li class="nav-item ${activetdv }"><a href="themdsqldv">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Thêm
											dịch vụ</a></li>
								</ul></li>

							<li class="nav-item ${activets }" style="cursor: pointer;"><a
								href="qlts"><i class="fa fa-fw fa-sitemap"></i> Quản lý nâng
									cao</a>
						</ul></li>
			...
			<ul class="navbar-nav ml-auto">
				<li class="dropdown user user-menu" style="margin-right: 35px;">
					...
					aria-expanded="false"> <img src="hinh/iconuser.png"
						width="30px" height="30px" /> <span class="hidden-xs">Xin chào ${nguoidung }</span>
				</a>
					...
					<ul class="dropdown-menu">
						...
						<li class="user-body">
							<div style="text-align: center;">
								...
								<a class="hoverUser" href="doimatkhau">Đổi mật khẩu</a>
							</div>

							<div style="text-align: center;">
								<a class="hoverUser" href="dangxuat">Đăng xuất</a>
							</div>
						</li>
					</ul>
				</li>
