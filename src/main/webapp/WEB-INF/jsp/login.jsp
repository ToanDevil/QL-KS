  ...
  <div class="wrapper">
	<div class="container">
		...
		<form class="form" action="actionlogin">
			<input name="tendangnhap" type="text" placeholder="Tên đăng nhập" required="required" maxlength="50" autocomplete="off">
			<input name="matkhau"type="password" placeholder="Mật khẩu" required="required" maxlength="100" autocomplete="off">
