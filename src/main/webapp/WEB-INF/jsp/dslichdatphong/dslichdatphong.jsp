...
<div class="container">
	<button type="button" class="btn btn-success" style="margin-bottom: 10px;" onclick="themlich(${maPhong},${soPhong})">
			...
			<tbody>
				<c:forEach var="u" items="${danhsach}">
					...
					<td></td>
						...
						<td style="white-space: nowrap;"><button type="button" class="btn btn-primary btn-sm" onclick="xoaLich(${maPhong},${soPhong},${u.maLich})">Xóa</button></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
