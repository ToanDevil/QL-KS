		...
		<div class="breadcrumb" style="box-shadow: 1px 1px 5px #888888;">
			<div>
				...
				<div class="form-group">
					<label for="tenDangNhap" style="font-weight: bold;">Tên
						đăng nhập:</label>
					<div class="col-sm-10">
						<frm:input id="tenDangNhap" class="form-control"
							path="tenDangNhap" placeholder="Nhập tên đăng nhập" maxlength="50"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<frm:input type="password" id="matKhau" class="form-control"
							path="matKhau" placeholder="Nhập mật khẩu" maxlength="100"/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<frm:input type="date" id="ngaySinh" class="form-control"
							path="ngaySinh" placeholder="Chọn ngày sinh" max="9999-12-31"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<frm:input type="number" id="CMND" class="form-control"
							path="cmnd" placeholder="Nhập số chứng minh nhân dân" oninput="checkMaxLenghtNumber(this,20)"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<frm:input type="number" id="soDT" class="form-control"
							path="soDT" placeholder="Nhập số điện thoại" oninput="checkMaxLenghtNumber(this,15)"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<frm:input type="Email" id="Email" class="form-control"
							path="Email" placeholder="Nhập địa chỉ email" oninput="checkMaxLenghtNumber(this,100)"/>
					</div>
				</div>
